...
bool string_span_try_chop_by_delim(struct string_span* ss, char delim, struct string_span* chunk)
{
	size_t i = 0;
...
struct string_span string_span_chop_by_delim(struct string_span* ss, char delim)
{
	size_t i = 0;
...
bool string_span_starts_with(struct string_span ss, struct string_span expected_prefix)
{
...
bool string_span_ends_with(struct string_span ss, struct string_span expected_suffix)
{
	if (expected_suffix.length > ss.length) {
		return false;
	}

	struct string_span actual_suffix = {ss.data + ss.length - expected_suffix.length, expected_suffix.length};
